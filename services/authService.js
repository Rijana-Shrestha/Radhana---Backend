...
const verifyEmail = async (token, email) => {
  ...
  if (!user) {
    ...
    user = await User.create({
      ...
      address: record.userData.address || { city: "", province: "", country: "Nepal" },
      roles: ["USER"],
    });
  }
...
export default { register, login, forgotPassword, resetPassword, oauthLogin, verifyEmail, checkVerificationStatus };
